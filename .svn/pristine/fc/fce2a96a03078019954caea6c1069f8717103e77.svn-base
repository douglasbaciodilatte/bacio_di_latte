...
/*/{Protheus.doc} Extrator
	@Desc Função tem como objetivo gerar querys e exportar em excel
...
User Function Extrator()
	...
	Local aParamBox := {}
	Local aCombo := {"SD1 - Itens Doc Entrada","SD2 - Itens Doc Saída","SD2 - Itens Doc Saída Sumarizado","SE2 - Contas a Pagar",;
	...
	If ParamBox(aParamBox,"Extrator Dados...",@aRet)
		If (ValType(aRet[1])=="N".And.aRet[1]==1).Or.(ValType(aRet[1])=="C".And.aRet[1]=="SD1 - Itens Doc Entrada")
			xProc1()
		ElseIf (ValType(aRet[1])=="N".And.aRet[1]==2).Or.(ValType(aRet[1])=="C".And.aRet[1]=="SD2 - Itens Doc Saída")
			xProc2()	
		ElseIf (ValType(aRet[1])=="N".And.aRet[1]==3).Or.(ValType(aRet[1])=="C".And.aRet[1]=="SD2 - Itens Doc Saída Sumarizado")
			xProc3()		
