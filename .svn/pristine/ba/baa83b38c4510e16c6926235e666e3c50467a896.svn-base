...
//    Local oFont35    := TFont():New('Arial',35,35,,.F.,,,,.T.,.F.,.F.)
    ...
    While QRYTMP->(!Eof())
        For nR := 1 to nQuant
            ...
            nLin+= 40
            nLinC        := 5.7          //Linha que será impresso o Código de Barra
            nColC        := 2         //Coluna que será impresso o Código de Barra
            nWidth       := 0.0164      //Numero do Tamanho da barra. Default 0.025 limite de largura da etiqueta é 0.0164
            nHeigth      := 1.6         //Numero da Altura da barra. Default 1.5 --- limite de altura é 0.3
