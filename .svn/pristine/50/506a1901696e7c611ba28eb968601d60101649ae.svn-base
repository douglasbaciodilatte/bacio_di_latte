...
aAdd( aHlpPor, 'Integração Neogrid.' )
aHlpEng := {}
aHlpSpa := {}
...
aHlpPor := {}
aAdd( aHlpPor, 'Data e hora da Emissão do Pedido pelo' )
...
aHlpPor := {}
aAdd( aHlpPor, 'Data e Hora do Inicio do Período de' )
aAdd( aHlpPor, 'Entrega na integração com o Neogrid' )
aHlpEng := {}
aHlpSpa := {}
...
aHlpPor := {}
aAdd( aHlpPor, 'Data e hora do fim do período de entrega' )
aHlpEng := {}
aHlpSpa := {}
