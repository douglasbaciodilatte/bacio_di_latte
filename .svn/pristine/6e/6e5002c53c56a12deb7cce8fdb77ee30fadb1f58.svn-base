...
User Function x2IMPFER()        // incluido pelo assistente de conversao do AP5 IDE em 03/07/00
...
굇쳝컴컴컴컴컵컴컴컴컴컴좔컴컴컴좔컴컴컴컴컴컴컴컴컴컴컴좔컴컴컨컴컴컴컴컴컴컴컴눙?
굇?escrio ?Recibo de Ferias                                                 낢?
굇쳝컴컴컴컴컵컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴눙?
굇?intaxe   ?ImpFer(void)                                                     낢?
굇쳝컴컴컴컴컵컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴눙?
굇?Uso      ?RDMAKE                                                           낢?
굇쳝컴컴컴컴컨컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴눙?
굇?        ATUALIZACOES SOFRIDAS DESDE A CONSTRUAO INICIAL.                   낢?
굇쳝컴컴컴컴컴컫컴컴컴컴쩡컴컴컴컴컴컫컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴눙?
굇?rogramador ?Data   ?BOPS       ? Motivo da Alteracao                     낢?
굇쳝컴컴컴컴컴컵컴컴컴컴탠컴컴컴컴컴컵컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴눙?
...
If lAchou
    ...
    @ nLi+35,001 PSAY "|" + SPACE(02) + UPPER("1 A empresa concedera ferias, referente ao periodo aquisitivo de           ") + "|"
    ...
    @ nLi+46,001 PSAY "|" + SPACE(02) + UPPER("3.1 Os valores das f�rias antecipadas + o adicional de 1/3 ser�o pagos em  ") + "|"
    @ nLi+47,001 PSAY "|" + SPACE(02) + UPPER("30 Dias (trinta) dias ap�s o efetivo in�cio do gozo pelo EMPREGADO.        ") + "|"
	@ nLi+48,001 PSAY "|" + SPACE(02) + UPPER("Assim, o pagamento das ferias ocorrera no dia "+DTOC(MV_PAR02)+"   ") + "|"	
    @ nLi+49,001 PSAY "|" + SPACE(77) + "|"
		
    @ nLi+50,001 PSAY "|" + SPACE(02) + UPPER("3.2 No ato da concessao das ferias, a EMPRESA fara o imediato acerto do    ") + "|"
    @ nLi+51,001 PSAY "|" + SPACE(02) + UPPER("saldo de salario que estiver pendente mediante deposito em conta bancaria  ") + "|"
    @ nLi+52,001 PSAY "|" + SPACE(02) + UPPER("de titularidade do EMPREGADO, a qual ja e de conhecimento da empresa.      ") + "|"
    @ nLi+53,001 PSAY "|" + SPACE(77) + "|"

    @ nLi+54,001 PSAY "|" + SPACE(02) + UPPER("4 O empregado que gozar somente ferias proporcionais tera reiniciada a     ") + "|"
    @ nLi+55,001 PSAY "|" + SPACE(02) + UPPER("contagem do periodo aquisitivo, quando do seu retorno ao trabalho similar a") + "|"
    @ nLi+56,001 PSAY "|" + SPACE(02) + UPPER("forma prevista no artigo 140 da CLT.                                       ") + "|"
    @ nLi+57,001 PSAY "*" + cReplic77 + "*"
    ...
    @ nLi+04,001 PSAY "|" + SPACE(02) + UPPER("como recibo de quitacao da parcela avencadas no presente acordo (e da      ") + "|"
	...
	If nRecib == 1
		...
		If dbSeek( SRA->RA_FILIAL + SRA->RA_MAT + "F" )
            ...
            @ nLi,001 PSAY "|  30 (trinta) dias apos o efetivo inicio do gozo                             |"
            nLi:=nLi+1
		
            @ nLi,001 PSAY "|  O pagamento serao efetuados mediante deposito bancario                     |"
            nLi:=nLi+1
...
굇 袴袴袴袴袴佶袴袴袴袴藝袴袴袴錮袴袴袴袴袴袴袴袴袴袴箇袴袴錮袴袴袴袴袴袴敲굇
굇?rograma  ?BusGozo  ?utor  ?iago Malta         ?Data ? 04/03/10   볝?
굇勝袴袴袴袴曲袴袴袴袴袴姦袴袴袴鳩袴袴袴袴袴袴袴袴袴蝰袴袴袴鳩袴袴袴袴袴袴묽?
굇?esc.     ? Fun豫o que busca os periodos e dias de Desfrute de Ferias 볝?
굇?         ?                                                           볝?
굇勝袴袴袴袴曲袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴袴묽?
굇?so       ?AP                                                         볝?
